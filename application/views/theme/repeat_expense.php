...
<div class="col-md-12 col-lg-12 col-sm-12 content-title"><h4>Repeating Expense</h4></div>
...
<div class="panel panel-default">
    ...
    <div class="panel-heading">Add Repeating Expense</div>
...
<div class="col-md-6 col-lg-6 col-sm-6"> 
  <div class="form-group">
    <label for="rotation-expense">Number Of Rotation (Payment)</label>
