...
class Admin extends CI_Controller {
    ...
    /** Method To Add New Account and Account Page View **/ 	
    public function addAccount($action='',$param1='')
	{
		...
		/** Method To insert Transaction when new account is created **/ 
    ...
    /** Method To view Manage Account Page **/ 
     public function manageAccount($action='')
	{
	 ...
	 /** Method To get account information for Account Editing **/ 
     ...
     public function transfer($action='',$param1='')
	{
	  ...
	  /** Method To view manage Income page **/ 
      public function manageIncome($action='')
	{
	  ...
	  /** Method To view manage Expense page **/ 
      public function manageExpense($action='')
	{
	   ...
	   /** Method To get data for edit transaction **/ 
       ...
       public function updateTransaction()
    {
      ...
      /** Method To View Repeat Income page **/ 
      public function repeatIncome($action='')
	{
        ...
        //echo "All Fields Must be Required With Valid Length !";
        echo validation_errors('<span class="ion-android-alert failedAlert2"> ','</span>');
        }
        //----End validation----//         
        }
	  ...
	  /** Method To View repeat Expense Page **/ 
      public function repeatExpense($action='')
	{
	  ...
	  /** Method To view Process Income page  **/ 
      public function processIncome($action='')
	{
	  ...
	  /** Method To view Process Expense page  **/
      public function processExpense($action='')
	{
		...
		/** Method To get data for edit repeat transaction  **/
        public function editRepeatTransaction($trans_id,$action='')
    {
	   ...
	   /** Method To Update repeat Transaction  **/
       public function updateRepeatTransaction()
    {
       ...
       echo "true";
         ...
         /** Method To view Income Calender page  **/
    ...
    { 
	  ...
	  /** Method To view Expense Calender page  **/
      public function expenseCalender($action='')
    {
	  ...
	  /** Method To process repeat Transaction  **/
      public function processRepeatTransaction($trans_id,$status)
    {
     if($this->Adminmodel->processRepeatTransaction($trans_id,$status)){
	  ...
	  /** Method To View,insert, update and delete Chart of accounts  **/
      public function chartOfAccounts($action='',$param1='')
	{
	    ...
	    /** Method To View,insert, update and delete payee And Payers  **/
    ...
    if(!value_exists2("payee_payers","payee_payers",$data['payee_payers'],"type",$data['type'],"trace_id",$id)){     
	   ...
	   /** Method To View,insert, update and delete payment method  **/
        ...
        public function userManagement($action='',$param1='')
	{
      ...
      /** Method To get user information for edit  **/
